...
var fetchInstagramPhotos = function (accountUrl) {
    return __awaiter(_this, void 0, void 0, function () {
        var response, json, edges, photos;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/ , axios.get(accountUrl)];
                case 1:
                    response = _a.sent();
                    json = JSON.parse(response.data.match(instagramRegExp)[1]);
                    edges = json.entry_data.ProfilePage[0].graphql.user.edge_owner_to_timeline_media.edges.splice(0, 6);
    ...
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/ , fetchInstagramPhotos('https://www.instagram.com/isabel_berglund/')];
                case 1:
                    photos = _a.sent();
